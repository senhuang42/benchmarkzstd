                               ...
                               void* workspace)
{
    ...
    DEBUGLOG(4, "ZSTD_loadZstdDictionary\n");
    /* dict as full zstd dictionary */
    return ZSTD_loadZstdDictionary(bs, ms, params, dict, dictSize, dtlm, workspace);
}

/* Filesize at which we use input to construct our cParams instead */
#define ZSTD_CDICT_PARAMS_CUTOFF (100)
                                    ...
                                    ZSTD_buffered_policy_e zbuff)
{
    ...
    if ( (cdict)
      ...
      && (pledgedSrcSize < ZSTD_CDICT_PARAMS_CUTOFF || cdict->compressionLevel == 0) ) {
        return ZSTD_resetCCtx_usingCDict(cctx, cdict, params, pledgedSrcSize, zbuff);
    } else {
        cctx->dictID = cdict->dictID;
        return ZSTD_resetCCtx_internal(cctx, params, pledgedSrcSize,
                                     ZSTDcrp_continue, zbuff);
    }
    ...
    ZSTD_frameParameters const fParams, unsigned long long const pledgedSrcSize)
{
    ...
    {   ZSTD_CCtx_params params = cctx->requestedParams;
        params.cParams = (pledgedSrcSize < ZSTD_CDICT_PARAMS_CUTOFF) || (cdict->compressionLevel == 0) ?
